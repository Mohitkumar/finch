...
func (c *logClient) ProduceStream(ctx context.Context, opts ...grpc.CallOption) (Log_ProduceStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &Log_ServiceDesc.Streams[0], "/Log/ProduceStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *logClient) ConsumeStream(ctx context.Context, opts ...grpc.CallOption) (Log_ConsumeStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &Log_ServiceDesc.Streams[1], "/Log/ConsumeStream", opts...)
	if err != nil {
		return nil, err
	}
